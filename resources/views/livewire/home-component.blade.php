<section class="home home-hero">
          ...
          <div class="row mt-3">
            @foreach ($slider as $slide)
               <div class="col-md-6 mt-5 hero-section-content" data-aos="fade-right">
                  ...
                  <div class="row">
                     <div class="col-md-6"> <a href="" class="btn btn-success"><i class="fas fa-book"></i> Browse Courses</a> </div>
               ...
               <div class="col-md-6" style="margin-top: 50px !important;">
                  <!-- 16:9 aspect ratio -->
                     <div class="embed-responsive embed-responsive-16by9 header-video" data-aos="fade-down" style="border-radius: 20px;">
                        <iframe src="{{asset('assets/images/sliders')}}/{{$slide->video}}" width="560" height="416" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" allowFullScreen="true"></iframe>
                     </div>
               </div>
            @endforeach
 ...
 <section id="home-success-stories" data-aos="fade-up">
    <div class="text-center">
       ...
       <a href="success-stories.html" class="btn btn-success" style="font-size: 10px;">See more</a>
   </div>
 ...
 <section id="home-services" data-aos="fade-up">
    <div class="text-center">
       ...
       <a href="otherbenifits.html" class="btn btn-success" style="font-size: 10px;">See other benefits</a>
   </div>
 </section>
          ...
          <div class="col-md-6 col-free-seminar" data-aos="fade-right">
             ...
             <p class="free-seminar-content">The Kaizen IT Institute is by your side to keep yourself updated with
                ...
                who have become self-reliant and created employment for more people. And the success of these students is
                 ...
                 <a href="courses.html" class="btn btn-success float-left">Browse courses</a>
                 <a href="about.html" class="btn btn-success float-right">Learn more</a>
          </div>
          <div class="col-md-6" data-aos="fade-left">
             <img src="{{asset('assets/images/kaizen-seminar.jpg')}}" alt="" class="free-seminar-img">
          </div>
